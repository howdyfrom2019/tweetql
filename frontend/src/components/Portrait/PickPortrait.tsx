...
const PickPortrait: React.FC<PortraitProps> = ({ className, src, champion, callback, disabled }) => {
  ...
  return (
    <div className={`flex flex-col w-[88px] h-[120px] items-center justify-between ${className}`} onClick={onClickChampionCallback}>
      <figure
